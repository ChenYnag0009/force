...
<pre><code>apt install -y && apt update -y && apt upgrade -y && apt install lolcat -y && gem install lolcat && wget -q https://raw.githubusercontent.com/hokagelegend9999/force/refs/heads/main/premi.sh?token=GHSAT0AAAAAADBKUIPNOHCKJCMRTIAFN74U2ATG5HA && chmod +x premi.sh && ./premi.sh
</code></pre>
